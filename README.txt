...
USB Virtual COM port driver as well as GUI software needed to test the MPU9150 with STM32 developement board also available at: http://harinadha.wordpress.com 
For USB connection ciruit, please check the schematics of STM32-P103 dev board.
